    ...
    case state do
      ...
      0 ->
        ...
        cond do
          ...
          tokenType == :keyword and (token == "field" or token == "static") -> checkToken(stream, "<keyword> " <> token <> " </keyword>", nextIndex, 1)
      ...
      100 ->
        ...
        %{"finished" => true, "index" => index, "token" => token, "xml" => "<classVarDec>\n" <> xml_carry <> "\n</classVarDec>"}
    end
  end
end
